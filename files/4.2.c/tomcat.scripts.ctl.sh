...
start_tomcat() {
	...
	rm -f $CATALINA_PID
	export JAVA_OPTS="$DEBUG_OPTS -XX:MaxPermSize=512m -Xms128m -Xmx1024m -XX:-DisableExplicitGC -Djava.awt.headless=false -Dalfresco.home=/home/share/home/hans/Program/alfresco-4.2.c -Dcom.sun.management.jmxremote -Dsun.security.ssl.allowUnsafeRenegotiation=true"
