...
start_tomcat() {
	...
	rm -f $CATALINA_PID
	export JAVA_OPTS="$DEBUG_OPTS -XX:MaxPermSize=256m -Xms128m -Xmx1024m -XX:+DisableExplicitGC -Djava.awt.headless=false -Dalfresco.home=<INSTALL_DIR> -Dcom.sun.management.jmxremote -Dsun.security.ssl.allowUnsafeRenegotiation=true -XX:ReservedCodeCacheSize=128m"
